...
const onSelectFile = (uploadFile) => {
  imgUrl.value = URL.createObjectURL(uploadFile.raw) // 预览选择的图片
  ...
  >
    ...
    <el-form :model="formModel" ref="formRef" label-width="100px">
      ...
      <el-form-item label="文章封面" prop="cover_img">
        <!-- 此处需要关闭 element-plus 的自动上传（auto-upload），不需要配置 action 等参数
      ...
      <el-form-item label="文章内容" prop="content">
        <div class="editor">
          <!-- 编辑器需要先安装包： pnpm add @vueup/vue-quill@latest 。在顶部按需导入后使用-->
          <quill-editor
            ref="editorRef"
